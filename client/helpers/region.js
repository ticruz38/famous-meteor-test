define('region', function (require, exports, module) {
    ...
    Lightbox.DEFAULT_OPTIONS = {
        ...
        inOpacity: 0,
        inOrigin: [0.5, 0.5],
        inSize: [undefined, undefined],
        outTransform: Transform.scale(0.001, 0.001, 0.001),
        outOpacity: 0,
        outOrigin: [0.5, 0.5],
        outSize: [undefined, undefined],
        showTransform: Transform.identity,
        showOpacity: 1,
        showOrigin: [0.5, 0.5],
        showSize: [undefined, undefined],
        inTransition: true,
        outTransition: true,
        overlap: false
    };
    ...
    Lightbox.prototype.show = function show(renderable, transition, callback) {
        ...
        var stateItem = {
            ...
            size: new Transitionable(this.options.inSize)
        };
        ...
        stateItem.size.set(this.options.showSize, transition, _cb);
    };
    ...
    Lightbox.prototype.hide = function hide(transition, callback) {
        ...
        stateItem.size.set(this.options.outSize, transition, _cb);
    };
